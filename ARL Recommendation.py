...
df_ = pd.read_excel("Datasets/online_retail_II.xlsx",sheet_name="Year_2010-2011")
df = df_.copy()
...
def check_df(dataframe, head=5):
    ...
    print('#################  Quantity ################# ')
    print(dataframe["Quantity"].sort_values().head())
    print('#################  Price ################# ')
    print(dataframe["Price"].sort_values().head())
...
# 3. Association Rules
##########################################
# # Creating a pivot table for 'Invoice' and 'Product' (Invoice - Product Matrix)
# #######################################################
